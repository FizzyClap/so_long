...
/*   Updated: 2024/07/02 17:35:04 by roespici         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (position == '1' || position == 'W' || position == '0' || \
		position == 'C' || position == 'B' || position == 'S' || \
		position == 'G' || position == 'P' || position == 'E' || \
	...
	while (++y < map->y)
	{
		...
		while (++x < map->x)
		{
			...
			if ((map->lines[0][x] != '1' || map->lines[y][0] != '1' || \
				...
				map->lines[y][map->x - 1] != '1') && map->lines[0][0] != 'H')
			{
